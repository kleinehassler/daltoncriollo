...
{
    public partial class frmVista_Facturas : Form
    {
        public frmVista_Facturas()
        {
            InitializeComponent();
        }
        ...
        private void Listar()
        {
            try
            {
                dataGridView1.DataSource = N_Clientes.Listar();
                this.formato();
            }
            catch (Exception ex)
            {
        ...
        private void frmVista_Facturas_Load(object sender, EventArgs e)
        {
            this.Listar();
        }
