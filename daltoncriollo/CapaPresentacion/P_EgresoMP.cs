...
{
    public partial class P_EgresoMP : Form
    {
        ...
        private void Listar()
        {
            try
            {
                dataGridView1.DataSource = N_Egreso.Listar();
                this.formato();
            }
            catch (Exception ex)
            {
        ...
        private void Buscar()
        {
            try
            {
                dataGridView1.DataSource = N_Egreso.Buscar(txtBuscar.Text);
                this.formato();
            }
            catch (Exception ex)
            {
        ...
        private void CargarBodegas()
        {
            try
            {
                cboBodega.DataSource = N_Egreso.SeleccionarBodega();
        ...
        private void CargarDocumentos()
        {
            try
            {
                cboComprobante.DataSource = N_Egreso.SeleccionarDocumento();
        ...
        private void P_EgresoMP_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                dgvMostarDetalle.DataSource = N_Egreso.ListarDetalle(Convert.ToInt32(dataGridView1.CurrentRow.Cells["ID"].Value));
